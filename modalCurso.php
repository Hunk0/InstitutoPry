...
<script type="text/javascript">
     ...
     $('#estadoPago').on('change.bootstrapSwitch', function (e, state) {
        ...
        if (e.target.checked == true) {
            ...
            <?php echo "var ruta = \"indexAjax.php?pid=" . base64_encode("presentacion/EditorAjax.php") . "&idCur=" . $_GET["idCur"] . "&idEst=" . $_GET["idEst"] . "&estado=\"+estado ;\n"; ?>
            $(<?php echo '"#Curso'.$_GET["idCur"].'"'?>).load(ruta);
